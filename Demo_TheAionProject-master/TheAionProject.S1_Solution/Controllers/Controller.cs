...
namespace TheAionProject
{
    ...
    public class Controller
    {
        ...
        private void InitializeMission()
        {
            ...
            //last name
            _gameConsoleView.DisplayGamePlayScreen("Mission Initialization - Last Name", Text.InitializeMissionGetTravelerSurname(), ActionMenu.MissionIntro, "");
            _gameConsoleView.DisplayInputBoxPrompt($"Enter your surname {_gameTraveler.Name}: ");
            _gameTraveler.Surname = _gameConsoleView.GetString();
            ...
            //
            // get traveler's currency
            //
            _gameConsoleView.DisplayGamePlayScreen("Mission Initialization - Currency", Text.InitializeMissionGetTravelerCurrency(_gameTraveler), ActionMenu.MissionIntro, "");
            _gameConsoleView.DisplayInputBoxPrompt($"Enter your starting currency {_gameTraveler.Currency}: ");
            _gameTraveler.Currency = _gameConsoleView.GetInteger();
